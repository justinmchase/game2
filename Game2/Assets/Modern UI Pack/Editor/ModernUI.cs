...
namespace Michsky.UI.ModernUIPack
{
    public class MUIPEditor : MonoBehaviour
    {
        ...
        static void HRZSL()
        {
            Instantiate(Resources.Load<GameObject>("Horizontal Selector/Standard")).GetComponent<MUIPEditor>();
        }
        ...
        [MenuItem("GameObject/Modern UI Pack/Modal Windows/Modal and Notification Canvas", false, 0)]
        static void MWMNC()
        {
            Instantiate(Resources.Load<GameObject>("Modal Windows/Modal and Notification Canvas")).GetComponent<MUIPEditor>();
        }
        ...
        static void SLRAN()
        {
            Instantiate(Resources.Load<GameObject>("Sliders/Range")).GetComponent<MUIPEditor>();
        }

        [MenuItem("GameObject/Modern UI Pack/Sliders/Range (Clean)", false, 0)]
        static void SLRANC()
        {
            Instantiate(Resources.Load<GameObject>("Sliders/Range (Clean)")).GetComponent<MUIPEditor>();
        }

        [MenuItem("GameObject/Modern UI Pack/Sliders/Range (Label)", false, 0)]
        static void SLRANL()
        {
            Instantiate(Resources.Load<GameObject>("Sliders/Range (Label)")).GetComponent<MUIPEditor>();
        }
